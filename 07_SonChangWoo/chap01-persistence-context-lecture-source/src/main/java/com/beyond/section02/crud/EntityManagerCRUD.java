package com.beyond.section02.crud;

import com.beyond.section01.entitymanager.EntityManagerGenerator;
...
public class EntityManagerCRUD {
  ...
  public Menu findByMenuCode(int menuCode) {
  ...
  public Long saveAndReturnAllCount(Menu newMenu) {
    ...
    // 새로운 엔티티 매니저 인스턴스 생성(각 작업마다 독립적인 영속성 컨택스트)
    entityManager = EntityManagerGenerator.getInstance();
